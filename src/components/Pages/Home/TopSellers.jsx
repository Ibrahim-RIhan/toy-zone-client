    ...
    return (
        <div className="my-20 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 justify-center items-center">
                <div className="w-full max-w-sm py-5 bg-white border border-gray-200 rounded-lg shadow ">
                    <div className="flex flex-col items-center pb-10">
                        <img className="w-24  mb-3 rounded-full shadow-lg" src={seller1} alt="Bonnie image" />
                        <Rating
                ...
                <div className="w-full max-w-sm py-5 bg-white border border-gray-200 rounded-lg shadow ">
                    <div className="flex flex-col items-center pb-10">
                        <img className="w-24  mb-3 rounded-full shadow-lg" src={seller3} alt="Bonnie image" />
                        <Rating
                ...
                <div className="w-full max-w-sm py-5 bg-white border border-gray-200 rounded-lg shadow ">
                    <div className="flex flex-col items-center pb-10">
                        <img className="w-24  mb-3 rounded-full shadow-lg" src={seller2} alt="Bonnie image" />
                        <Rating
