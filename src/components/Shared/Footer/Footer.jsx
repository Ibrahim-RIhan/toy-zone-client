...
const Footer = () => {
    return (
        ...
        <footer className="footer bg-stone-900 footer-center mt-7 p-5 text-white ">
            <div>
                <img className='w-48' src={logo} alt="" />
                <p className="font-bold text-3xl">
                  Toy Zone
                </p>
                <p>Buy Special Toys for your Kids</p>
                <p>Email US : toyzone@info.com</p>
                <p>Contact Us : 04561-56134</p>
                <p>Address : 13/A Los-Santos , USA</p>
